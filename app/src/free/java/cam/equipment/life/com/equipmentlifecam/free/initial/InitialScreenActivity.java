package cam.equipment.life.com.equipmentlifecam.free.initial;
...
import cam.equipment.life.com.equipmentlifecam.free.signupfacebook.SignUpFacebookActivity;
...
public class InitialScreenActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            Log.i(TAG, "onCreate() inside IF session.isLoggedIn(): " + session.isLoggedIn());
    ...
    private void showDialogLoginCredentialsRegistration() {
        ...
        dialogCredentialRegistration.setCancelable(false);
    ...
    private void goToSignUpGoogle() {
        ...
        dialogGoogleSignIn.setCancelable(false);
