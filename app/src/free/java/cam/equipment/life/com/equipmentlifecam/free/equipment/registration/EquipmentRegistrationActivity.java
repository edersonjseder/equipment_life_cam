package cam.equipment.life.com.equipmentlifecam.free.equipment.registration;
...
public class EquipmentRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session.editor.putLong(FLAG_LIMIT, inserts);
    ...
    public void onSaveButtonClicked() {
        ...
        AppExecutors.getsInstance().getDiskIO().execute(new Runnable() {
            ...
            public void run() {
                ...
                inserts = mDb.equipmentDao().insertEquipment(equipment);

                verifyAmountOfInserts(inserts);
            ...
            Task<Uri> urlTask = uploadTask.addOnProgressListener(new OnProgressListener<UploadTask.TaskSnapshot>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        progressBarEquipmentRegistPictureUpload.setVisibility(View.GONE);
    ...
    private void verifyAmountOfInserts(long insertions) {
        Log.i(TAG, "verifyAmountOfInserts() inside method: " + insertions);
